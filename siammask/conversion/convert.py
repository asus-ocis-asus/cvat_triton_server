...
parser.add_argument('--config', dest='config', default='siammask/config_davis.json',
...
if __name__ == '__main__':
    ...
    scripted_mask_conv_head = torch.jit.script(siammask.mask_model.mask.head)
    scripted_mask_conv_head.save(os.path.join(outdir, 'mask_head.pt'))
